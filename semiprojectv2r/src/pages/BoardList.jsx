...
const BoardList = () => {
    ...
    // 엔드포인트에서 path 변수 추출
    // useParams : URL 경로상 정의된 매개변수로 값을 추출
                ...
                <tr>
                    <td colSpan="6">
                        <ul className="pagination">
                            { (boardData.cpg > 1) &&
                                (<li className="page-item"><a href={`/board/list/${boardData.cpg - 1}`} className="page-link">이전</a></li>)}
                        {
                            (() =>{
                                const pgns=[];
                            ...
                            { (boardData.cpg < boardData.cntpg) &&
                                (<li className="page-item"><a href={`/board/list/${boardData.cpg + 1}`} className="page-link">다음</a></li>)}
                        </ul>
                    </td>
                </tr>
                </tfoot>
